...
// import './caractere1.css'; // Assurez-vous d'inclure le CSS si nécessaire
...
function Caractere3() {
  ...
  const handleNextBubble = () => {
    ...
    if (currentMessage < messages.length - 1) {
      ...
      setTimeout(() => {
        navigate('/pick'); // Rediriger vers le questionnaire après la dernière bulle
      }, 1000);
    }
  };
